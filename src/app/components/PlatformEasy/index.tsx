...
export const PlatformEasy = () => {
  return (
    <div className="flex justify-end items-center px-40 relative bg-right bg-no-repeat xl:bg-phoneWithQrCode h-height500 mt-44">
      <div className="flex flex-col gap-5 text-white w-width501">
        ...
        <div>
          <MainButton bgColor="bg-white" color="text-darkerGray font-bold">
